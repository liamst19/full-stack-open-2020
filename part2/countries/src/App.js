...
import axios from 'axios';
  ...
  return (<div><h3>{`Weather in ${props.country.capital}`}</h3>
  ...
  const CountryDetails = props => {
    ...
    return (<div>
      ...
      <div><img src={props.country.flag} alt={`flag of ${props.country.name}`} width="200px" /></div>
  ...
  return (<div>
    <FilterCountries filter={countryFilter} handleChange={setCountryFilter} />
